package com.orangehaswing.extra.ssh;
...
import com.orangehaswing.extra.ftp.AbstractFtp;
...
public class Sftp extends AbstractFtp {
		...
		try {
			channel.ls(path, new LsEntrySelector() {
				...
				public int select(LsEntry entry) {
					...
					if (false == StrUtil.equals(".", fileName) && false == StrUtil.equals("src/main", fileName)) {
	...
	public boolean delDir(String dirPath) {
		...
		for (LsEntry entry : list) {
			...
			if (false == fileName.equals(".") && false == fileName.equals("src/main")) {
