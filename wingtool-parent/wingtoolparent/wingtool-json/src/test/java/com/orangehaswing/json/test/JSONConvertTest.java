...
import com.orangehaswing.json.test.bean.ExamInfoDict;
import com.orangehaswing.json.test.bean.PerfectEvaluationProductResVo;
import com.orangehaswing.json.test.bean.UserInfoDict;
