package com.orangehaswing.core.bean;

import com.orangehaswing.core.bean.BeanDesc.PropDesc;
...
import com.orangehaswing.core.lang.Editor;
import com.orangehaswing.core.lang.Filter;
import com.orangehaswing.core.map.CaseInsensitiveMap;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.orangehaswing.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.orangehaswing.TestEntity匹配com.orangehaswing.TestEntity
	 * 
	 * @param bean Bean
