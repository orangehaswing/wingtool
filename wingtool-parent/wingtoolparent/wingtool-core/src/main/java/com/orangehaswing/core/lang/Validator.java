package com.orangehaswing.core.lang;

import com.orangehaswing.core.date.DateUtil;
import com.orangehaswing.core.exceptions.ValidateException;
...
public class Validator {
	...
	public static boolean isLetter(CharSequence value) {
		return StrUtil.isAllCharMatch(value, new com.orangehaswing.core.lang.Matcher<Character>() {
			@Override
