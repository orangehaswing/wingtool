package com.orangehaswing.log.dialect.log4j2;
...
import com.orangehaswing.log.AbstractLocationAwareLog;
...
public class Log4j2Log extends AbstractLocationAwareLog {
	...
	@Override
	public void log(String fqcn, com.orangehaswing.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4j2Level;
		switch (level) {
			case TRACE:
